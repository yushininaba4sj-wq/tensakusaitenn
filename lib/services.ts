...
export const SERVICES: ServiceInfo[] = [
  {
    id: "plan",
    title: "学習計画",
    short: "年間・月間・週間・今日やることを計画",
    tabLabel: "計画",
    price: "¥980",
    priceNote: "/ 月〜",
    href: "/plan",
    features: [
      "志望校・偏差値・試験日からあなたに合った計画を立てる",
      "進捗に合わせて毎日見直し",
      "志望校合格の現役大学生にも相談可能",
    ],
  },
